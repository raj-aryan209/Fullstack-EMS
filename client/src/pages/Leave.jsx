...
import { FileSliders, PalmtreeIcon, PlusIcon, ThermometerIcon, UmbrellaIcon } from "lucide-react"
    ...
    <div className="animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        <div>
          ...
          <p>{isAdmin ? "Manage leave application" : "Your leave history and requestes"}</p>
        </div>
        {!isAdmin && (
          ...
          {!isAdmin && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:group-5 mb-8">
              {leaveStats.map((s)=>(
