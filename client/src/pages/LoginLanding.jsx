...
const LoginLanding = () => {
  ...
  const portalOptions = [
    ...
    { 
      ...
      description: "View your profile, track attendance, request time off, and access your payslips.", 
      icon: UserIcon
    },
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="flex w-full md:w-1/2 flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
                ...
                {portalOptions.map((portal)=>(
                  ...
                  className="group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 transition-all duration-300 hover:border-indigo-400 hover:bg:indigo-50">
                    <div className="relative z-10 flex items-center justify-between gap-4 sm:gap-5">
                        ...
                        <ArrowRightIcon className="w-4 h-4 text-slate-400 group-hover:text-indigo-600 transition-x-1 transition-all duration-300"/>
                    </div>
