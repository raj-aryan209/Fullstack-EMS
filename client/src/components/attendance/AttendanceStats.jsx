import { Calendar, CalendarIcon, CircleIcon } from 'lucide-react';
...
const AttendanceStats = ({history}) => {
  ...
  const stats = [
    ...
    {label: "Late Arrivals", value: totalLate, icon: CircleIcon},
    {label: "Avg. Work Hrs", value: "8.5 Hrs", icon: CircleIcon},
  ]
