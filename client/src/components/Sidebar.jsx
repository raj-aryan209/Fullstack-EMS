...
const Sidebar = () => {
  ...
  const sidebarContent = (
    <>
      {/* Brand Header */}
      <div className="px-5 pt-6 border-b border-white/10">
  ...
  return (
    <>
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:flex flex-col h-full w-64 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white border-r border-white/10">
        {sidebarContent}
      </aside>
